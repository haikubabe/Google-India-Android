...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 230;

    private static final int ACTION_DRINK_PENDING_INTENT_ID = 500;
    ...
    private static Action drinkWaterAction(Context context) {
        ...
        PendingIntent drinkWaterPendingIntent = PendingIntent.getService(context, ACTION_DRINK_PENDING_INTENT_ID, drinkWaterIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        Action drinkWaterAction = new Action(R.drawable.ic_drink_notification, "I did it", drinkWaterPendingIntent);
