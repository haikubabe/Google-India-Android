...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_NOTIFICATION_ID = 100;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        //create a notification channel for Android O as notifications doesn't exists without notification channel
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(WATER_REMINDER_NOTIFICATION_CHANNEL_ID, context.getString(R.string.charging_reminder_notification_channel_name), NotificationManager.IMPORTANCE_HIGH);
