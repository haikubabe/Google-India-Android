...
//      TODO (7) Replace the single TextView with Views to display all of the weather info
        ...
        String weatherDate = SunshineDateUtils.getFriendlyDateString(mContext, dateInMillis, false);
         /* Use the weatherId to obtain the proper description */
        int weatherId = mCursor.getInt(MainActivity.INDEX_WEATHER_CONDITION_ID);
        int weatherDrawableIcon = SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId);
        ...
        forecastAdapterViewHolder.weatherIcon.setImageResource(weatherDrawableIcon);
        forecastAdapterViewHolder.weatherDate.setText(weatherDate);
        forecastAdapterViewHolder.weatherDescription.setText(weatherDescription);
        forecastAdapterViewHolder.maxTemperature.setText(highTemp);
        forecastAdapterViewHolder.minTemperature.setText(lowTemp);
    }
...
//          TODO (6) Get references to all new views and delete this line
            ...
            maxTemperature = (TextView) view.findViewById(R.id.tv_max_temperature);
            minTemperature = (TextView) view.findViewById(R.id.tv_min_temperature);
