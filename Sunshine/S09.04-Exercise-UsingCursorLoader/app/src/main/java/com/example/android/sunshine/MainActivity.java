...
//      TODO (20) Implement LoaderCallbacks<Cursor> instead of String[]
    ...
    private static final int INDEX_COLUMN_MAX_TEMP = 1;
    private static final int INDEX_COLUMN_MIN_TEMP = 2;
    private static final int INDEX_COLUMN_WEATHER_ID = 3;
...
//          TODO (22) If the loader requested is our forecast loader, return the appropriate CursorLoader
        switch (id) {
            case ID_FORECAST_LOADER:
                ...
                return new CursorLoader(this, forecastQueryUri, PROJECTION, selection, null, sortOrder);
            default:
