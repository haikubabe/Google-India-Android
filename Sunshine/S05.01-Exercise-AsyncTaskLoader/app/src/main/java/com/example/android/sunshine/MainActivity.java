...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int WEATHER_FETCH_LOADER = 20;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(WEATHER_FETCH_LOADER, null, this);
    }
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            String[] mWeatherResponse = null;

            @Override
            protected void onStartLoading() {
                mLoadingIndicator.setVisibility(View.VISIBLE);
                if (mWeatherResponse != null)
                    deliverResult(mWeatherResponse);
                else
                    forceLoad();
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            getSupportLoaderManager().restartLoader(WEATHER_FETCH_LOADER,null,this);
            return true;
        }
