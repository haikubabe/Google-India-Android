...
public class SunshineSyncUtils {
    ...
    private static final int WEATHER_SYNC_INTERVAL_HOURS = 3;
    private static final int WEATHER_SYNC_INTERVAL_SECONDS = (int) TimeUnit.HOURS.toSeconds(WEATHER_SYNC_INTERVAL_HOURS);
    private static final int WEATHER_SYNC_FLEXTIME_SECONDS = WEATHER_SYNC_INTERVAL_SECONDS;

    private static boolean sInitialized;

    //  TODO (11) Add a sync tag to identify our sync job

    private static final String WEATHER_SYNC_JOB_TAG = "SUNSHINE_SYNC_TAG";
    ...
    public static void scheduleFirebaseJobDispatcherSync(Context context) {
        ...
        Job constraintWeatherJob = firebaseJobDispatcher.newJobBuilder()
        ...
        firebaseJobDispatcher.schedule(constraintWeatherJob);
    }
