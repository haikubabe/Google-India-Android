...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        return sharedPreferences.getString(context.getString(R.string.pref_location_key),context.getResources().getString(R.string.pref_location_default));
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        /** This will be implemented in a future lesson **/
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String unit = sharedPreferences.getString(context.getString(R.string.pref_units_key),context.getResources().getString(R.string.pref_units_metric));
        if (unit.equals("metric")) return true;
        else return false;
    }
