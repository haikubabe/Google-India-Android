...
public final class SunshinePreferences {
    ...
    public static boolean areNotificationsEnabled(Context context) {
        String notificationKey = context.getString(R.string.pref_enable_notifications_key);
        boolean defaultNotificationValue = context.getResources().getBoolean(R.bool.show_notification_by_default);
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        boolean shouldDisplayNotification = sharedPreferences.getBoolean(notificationKey, defaultNotificationValue);
