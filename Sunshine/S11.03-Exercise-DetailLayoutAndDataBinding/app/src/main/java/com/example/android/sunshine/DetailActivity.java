...
//      TODO (8) Use mDetailBinding to display the date
        mDetailBinding.primaryWeatherInfo.tvWeatherDate.setText(dateText);
...
//      TODO (15) Create the content description for the description for a11y
        String descriptionAlly = getResources().getString(R.string.a11y_forecast, description);
//      TODO (9) Use mDetailBinding to display the description and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.tvWeatherDescription.setContentDescription(descriptionAlly);
//      TODO (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.primaryWeatherInfo.weatherIcon.setContentDescription(descriptionAlly);
...
//      TODO (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.tvMaxTemperature.setText(highString);
        mDetailBinding.primaryWeatherInfo.tvMaxTemperature.setContentDescription(highAlly);
...
//      TODO (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.tvMinTemperature.setText(lowString);
        mDetailBinding.primaryWeatherInfo.tvMinTemperature.setContentDescription(lowAlly);
...
//      TODO (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.extraWeatherDetails.humidityLabel.setContentDescription(humidityAlly);
...
//      TODO (13) Use mDetailBinding to display the wind and set the content description
        ...
        mDetailBinding.extraWeatherDetails.windMeasurement.setText(windString);
        mDetailBinding.extraWeatherDetails.windMeasurement.setContentDescription(windAlly);
//      TODO (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.extraWeatherDetails.windLabel.setContentDescription(windAlly);
...
//      TODO (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.extraWeatherDetails.pressureLabel.setContentDescription(pressureAlly);
